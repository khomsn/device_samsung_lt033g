...
PRODUCT_COPY_FILES += \
     ...
     $(LOCAL_PATH)/Dolby-ViperFx/system/lib/libacdbloader.so:system/lib/libacdbloader.so \
     ...
     $(LOCAL_PATH)/Dolby-ViperFx/system/lib/libbeatscorehtc.so:system/lib/libbeatscorehtc.so \
...
#PRODUCT_COPY_FILES += \
     $(LOCAL_PATH)/Dolby-ViperFx/system/lib/soundfx/libznrwrapper.so:system/lib/soundfx/libznrwrapper.so \
     $(LOCAL_PATH)/Dolby-ViperFx/system/lib/soundfx/libqcvirt.so:system/lib/soundfx/libqcvirt.so \
     $(LOCAL_PATH)/Dolby-ViperFx/system/lib/soundfx/libvpt51wrapper.so:system/lib/soundfx/libvpt51wrapper.so \
     $(LOCAL_PATH)/Dolby-ViperFx/system/lib/soundfx/libsrsfx.so:system/lib/soundfx/libsrsfx.so \
     $(LOCAL_PATH)/Dolby-ViperFx/system/lib/soundfx/libqcreverb.so:system/lib/soundfx/libqcreverb.so \
     $(LOCAL_PATH)/Dolby-ViperFx/system/lib/soundfx/libsrscorehtc.so:system/lib/soundfx/libsrscorehtc.so \
     $(LOCAL_PATH)/Dolby-ViperFx/system/lib/soundfx/libbeatscorehtc.so:system/lib/soundfx/libbeatscorehtc.so \
     $(LOCAL_PATH)/Dolby-ViperFx/system/lib/soundfx/libxloudwrapper.so:system/lib/soundfx/libxloudwrapper.so \
     $(LOCAL_PATH)/Dolby-ViperFx/system/lib/soundfx/libsrstb.so:system/lib/soundfx/libsrstb.so \
     $(LOCAL_PATH)/Dolby-ViperFx/system/lib/soundfx/libqcbassboost.so:system/lib/soundfx/libqcbassboost.so \
